  ...
  <PolicyWrapper :contentItems="contentItems">
    ...
    <template #content>
      <p>
        ...
        <a href="https://client.blanball.com">client.blanball.com</a> website
      ...
      <p>
        ...
        you create an account, or fill any forms on the Website. When required,
      ...
      <ul>
        ...
        <li>
          Sensitive personal information (such as ethnicity, religious beliefs,
          mental health, etc)
        </li>
        <li>
      ...
      <p>
        ...
        law. When we do, we will send you an email, get in touch with you over
        the phone.
      </p>
      ...
      <p>This document was last updated on April 13, 2023</p>
    </template>
  </PolicyWrapper>
</template>
