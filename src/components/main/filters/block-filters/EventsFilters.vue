...
import ButtonDetailsFilters from '@mainComponents/filters/components/ButtonDetailsFilters.vue';
import ClearFilters from '@mainComponents/filters/components/ClearFilters.vue';
import PositionMapModal from '@mainComponents/maps/PositionMapModal.vue';
import ModalFilters from '@mainComponents/filters/ModalEventsFilters.vue';
