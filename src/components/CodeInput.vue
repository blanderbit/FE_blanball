...
<script setup>
    import { defineProps, defineEmits, ref, toRef, onBeforeUpdate, onMounted, onBeforeUnmount } from "vue";
    ...
    const onValueChange = (e) => {
        ...
        if (e.target.value === "" || (pattern ? pattern.match(e.target.value) : false)) {
            return;
        }
