<template>
  ...
  <div onselectstart="return false">
    <div class="cbtn" @click="isShowPanel = !isShowPanel, createpopper()" ref="cbtnEl">
      ...
      <div class="huebar-wrapper">
        ...
        <div class="bar-wrapper">
          <div class="hue-bar" ref="hueBarEl" @click.stop="getHuePickerPos"
            ...
            <div class="picker" ref="huePickerEl" style="top: -1px"
                 @mousedown.stop="bindDown($event, getHuePickerPos)"></div>
          </div>
...
<script setup>
  import { ref, reactive, onMounted, nextTick, watch, defineProps, defineEmits, onBeforeUnmount } from 'vue'
