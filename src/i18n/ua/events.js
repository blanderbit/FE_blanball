export default {
  ...
  'need-ball-subtitle':
    'Увімкніть, якщо ви не маєте м’яча, аби хтось із запрошених приніс свій',
  date: 'Дата',
  time: 'Час',
  place: 'Місце проведення',
  confidentiality: 'Конфіденційність',
  vip: 'ViP',
  'agree-to-get-requests': 'Чи бажаєте ви отримувати запити на участь у події?',
  join: 'Долучитися',
  apply: 'Подати заявку',
  'leave': 'Скасувати участь',
  ...
  'enter-amount-members':
    'Вкажіть кількість людей, які можуть прийняти участь у події',
